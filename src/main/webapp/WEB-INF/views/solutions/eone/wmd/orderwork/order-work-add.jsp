...
$(function(){
	...
	window.OrderWorkAdd = (function($){
		...
		, _addOrderWork = function(){
			var $contents = $(".contents-wrap");
			if($contents.validate()){
				SfpAjax.ajax("<c:url value='/solutions/eone/wmd/orderwork/add'/>", $contents.find("select, input, textarea").serialize(), function(data) {
					alert("저장에 성공하였습니다.");
					Dialog.close(true);
				});
			}
...
<main>
	<header>
		<h2><s:interpret word='지시별 작업 내역 등록' abbr='' /></h2>
	</header>
