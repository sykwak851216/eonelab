	...
	window.MachineAdd = (function($){
		...
		, _addMachine = function(){
			...
			if($contents.validate()){
				SfpAjax.ajax("<c:url value='/solutions/eone/wmd/machine/add'/>", $contents.find("select, input, textarea").serialize(), function(data) {
					alert("저장에 성공하였습니다.");
					Dialog.close(true);
				});
			}
...
<main>
	<header>
		<h2><s:interpret word='설비 등록' abbr='' /></h2>
	</header>
		...
		<section>
			<div class="register-table">
				...
				<ul>
					...
					<li>
						<div class="title"><s:interpret word='설비명' abbr='' /><em>*</em></div>
						<div class="cont">
							<div class="line-wrap">
								<span><input type="text" name="mcName" placeholder="<s:interpret word='설비명' abbr='' />" data-valid-max-size='100' data-required="true"  /></span>
							</div>
						</div>
					</li>
				</ul>
