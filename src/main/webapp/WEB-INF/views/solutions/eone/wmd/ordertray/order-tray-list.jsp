...
$(function(){
	...
	window.OrderTrayList = (function($){
		...
		, _bindEvent = function(){
			...
			$("#order-tray-grid").on("click", ".btn-mod", function() {
				Dialog.open("<c:url value='/solutions/eone/wmd/ordertray/order-tray-modify.dialog' />",750, $("#order-tray-grid").grid("getData", this), function(){
					list();
				});
			});
			$(".btn-add").click(function() {
				Dialog.open("<c:url value='/solutions/eone/wmd/ordertray/order-tray-add.dialog' />",750, null, function(){
					list();
				});
			});
