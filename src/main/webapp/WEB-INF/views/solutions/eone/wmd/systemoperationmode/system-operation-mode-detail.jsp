...
<main>
	<header>
		<h2><s:interpret word='시스템 동작 모드 상세' abbr='' /></h2>
	</header>
		...
		<section>
			<div class="register-table">
				<ul>
					...
					<li>
						<div class="title"><s:interpret word='시스템동작모드명' abbr='' /></div>
						<div class="cont">
							<div class="line-wrap">
								<span id="systemOperationModeName"></span>
							</div>
						</div>
					</li>
					<li>
						...
						<div class="cont">
							<div class="line-wrap">
								<span id="systemOperationModeDesc"></span>
							</div>
						</div>
					</li>
					<li>
