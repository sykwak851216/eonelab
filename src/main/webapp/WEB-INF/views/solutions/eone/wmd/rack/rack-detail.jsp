...
<main>
	<header>
		<h2><s:interpret word='랙 상세' abbr='' /></h2>
	</header>
		...
		<section>
			<div class="register-table">
				<ul>
					...
					<li>
						<div class="title"><s:interpret word='랙명' abbr='' /></div>
						<div class="cont">
							<div class="line-wrap">
					...
					<li>
						<div class="title"><s:interpret word='랙X축 사이즈' abbr='' /></div>
						<div class="cont">
							<div class="line-wrap">
								<span id="rackXAxisSize"></span>
							</div>
						</div>
					</li>
					<li>
						<div class="title"><s:interpret word='랙Y축 사이즈' abbr='' /></div>
						<div class="cont">
							<div class="line-wrap">
								<span id="rackYAxisSize"></span>
							</div>
						</div>
					</li>
					<li>
